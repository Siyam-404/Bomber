...
time.sleep(0.3)
print(f"{YELLOW}       SMS BOMBER TOOL - {CYAN}SIYAM KING{RESET}")
time.sleep(0.3)
print(f"{RED}============================================{RESET}")
time.sleep(0.3)
print()
print(f"{YELLOW}          Developed by: {YELLOW}SIYAM King{RESET}")
time.sleep(0.3)
...
time.sleep(0.3)
print()
os.system('espeak -a 150 "Welcome bro, SMS Bomber Tool, SIYAM King"')
